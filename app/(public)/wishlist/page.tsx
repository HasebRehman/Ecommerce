  ...
  if (!isAuthenticated) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-white text-xl font-bold">Login to view wishlist</p>
        <p className="text-slate-400 mt-2 mb-6">Save your favourite products</p>
        <Link href="/login">
              ...
              <div key={item.id} className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden group">
                <div className="relative aspect-square bg-slate-800">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 w-7 h-7 bg-red-500 rounded-full flex items-center justify-center text-white opacity-0 group-hover:opacity-100 transition-opacity text-lg leading-none"
                  >
                    ×
                  </button>
                </div>
                <div className="p-3 space-y-2">
                  ...
                  <p className="text-white font-bold text-sm">Rs. {price.toLocaleString()}</p>
                  <button
