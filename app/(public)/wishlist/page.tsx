    ...
    <>
      ...
      <div className="wl-root wl-empty-state">
        <div className="wl-hero-icon">
          <Heart className="w-9 h-9" style={{ color: '#fff' }} />
        </div>
                  ...
                  <Link href={`/product/${p.id}`} className="block w-full h-full">
                    {p.images?.[0] ? (
                      ...
                      <div className="w-full h-full flex items-center justify-center"
                        ...
                        <Heart className="w-8 h-8" style={{ color: '#7C3AED' }} />
                      </div>
                    )}
                  </Link>
...
const sharedStyles = `
  ...
  .wl-root { font-family: 'Open Sans', sans-serif; }
  ...
  .wl-hero-icon {
    ...
    box-shadow: 0 10px 30px rgba(124,58,237,0.2), 0 0 0 1px rgba(124,58,237,0.12);
    margin-bottom: 8px;
  }
  .wl-empty-title {
    font-family: 'Montserrat', sans-serif;
  ...
  .wl-card:hover {
    ...
    box-shadow: 0 12px 32px rgba(124,58,237,0.18), 0 0 0 1px rgba(124,58,237,0.12);
  }

  /* ── image wrap ── */
  .wl-img-wrap { aspect-ratio: 1 / 1; background: #F3E8FF; }
  ...
  /* ── image hover overlay ── */
  .wl-img-overlay {
    background: linear-gradient(to top, rgba(31,41,55,0.70) 0%, rgba(31,41,55,0.10) 45%, transparent 100%);
    opacity: 0;
  ...
  .wl-move-btn:disabled { opacity: 0.55; cursor: not-allowed; }
  ...
  .wl-shop-name:hover { color: #6D28D9; }
  ...
  .wl-product-name:hover { color: #7C3AED; }
  ...
  .wl-move-btn-bottom:disabled { opacity: 0.50; cursor: not-allowed; }
`